...
public class CustomizedXPathVisitor extends XPathGrammarBaseVisitor<LinkedList> {
    ...
    @Override public LinkedList<Node> visitBraceRP(XPathGrammarParser.BraceRPContext ctx) { return visit(ctx.rp()); }
    ...
    @Override public LinkedList<Node> visitSelfRP(XPathGrammarParser.SelfRPContext ctx) { return currentNodes; }
    ...
    @Override public LinkedList<Node> visitEqFilter(XPathGrammarParser.EqFilterContext ctx) {
        LinkedList<Node> keepCurrent = currentNodes;
        LinkedList<Node> results = new LinkedList<>();
    ...
    @Override public LinkedList<Node> visitBraceFilter(XPathGrammarParser.BraceFilterContext ctx) { return visit(ctx.f()); }

    @Override public LinkedList<Node> visitTagName(XPathGrammarParser.TagNameContext ctx) { return visitChildren(ctx); }

    @Override public LinkedList<Node> visitAttName(XPathGrammarParser.AttNameContext ctx) { return visitChildren(ctx); }
